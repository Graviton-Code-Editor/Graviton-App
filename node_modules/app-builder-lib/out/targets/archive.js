...
/** @internal */
function tar(_x, _x2, _x3, _x4, _x5, _x6) {
  return _tar.apply(this, arguments);
}

function _tar() {
  _tar = (0, _bluebirdLst().coroutine)(function* (compression, format, outFile, dirToArchive, isMacApp, tempDirManager) {
...
function archive(_x7, _x8, _x9) {
  return _archive.apply(this, arguments);
}

function _archive() {
  _archive = (0, _bluebirdLst().coroutine)(function* (format, outFile, dirToArchive, options = {}) {
