...
class FpmTarget extends _core().Target {
  ...
  build(appOutDir, arch) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const artifactPath = path.join(_this3.outDir, packager.expandArtifactNamePattern(_this3.options, target, arch, nameFormat, !isUseArchIfX64));
      ...
      if (packager.packagerOptions.effectiveOptionComputed != null && (yield packager.packagerOptions.effectiveOptionComputed([args, desktopFilePath]))) {
        return;
      }
      ...
      yield packager.dispatchArtifactCreated(artifactPath, _this3, arch);
    })();
  }
