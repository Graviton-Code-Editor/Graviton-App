...
function computeLicensePage(_x, _x2, _x3, _x4) {
  return _computeLicensePage.apply(this, arguments);
} function _computeLicensePage() {
  _computeLicensePage = (0, _bluebirdLst().coroutine)(function* (packager, options, scriptGenerator, languages) {
