...
function writeCustomLangFile(_x, _x2) {
  return _writeCustomLangFile.apply(this, arguments);
}

function _writeCustomLangFile() {
  _writeCustomLangFile = (0, _bluebirdLst().coroutine)(function* (data, packager) {
...
function addCustomMessageFileInclude(_x3, _x4, _x5, _x6) {
  return _addCustomMessageFileInclude.apply(this, arguments);
}

function _addCustomMessageFileInclude() {
  _addCustomMessageFileInclude = (0, _bluebirdLst().coroutine)(function* (input, packager, scriptGenerator, langConfigurator) {
