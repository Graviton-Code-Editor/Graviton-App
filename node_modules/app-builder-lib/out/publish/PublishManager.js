...
function getAppUpdatePublishConfiguration(_x2, _x3, _x4) {
  return _getAppUpdatePublishConfiguration.apply(this, arguments);
}

function _getAppUpdatePublishConfiguration() {
  _getAppUpdatePublishConfiguration = (0, _bluebirdLst().coroutine)(function* (packager, arch, errorIfCannot) {
    ...
    if (packager.platform === _index().Platform.WINDOWS && publishConfig.publisherName == null) {
      ...
      const publisherName = winPackager.isForceCodeSigningVerification ? yield winPackager.computedPublisherName.value : undefined;
...
function getPublishConfigsForUpdateInfo(_x5, _x6, _x7) {
  return _getPublishConfigsForUpdateInfo.apply(this, arguments);
}

function _getPublishConfigsForUpdateInfo() {
  _getPublishConfigsForUpdateInfo = (0, _bluebirdLst().coroutine)(function* (packager, publishConfigs, arch) {
    if (publishConfigs === null) {
      return null;
    }
...
function getPublishConfigs(_x8, _x9, _x10, _x11) {
  return _getPublishConfigs.apply(this, arguments);
}

function _getPublishConfigs() {
  _getPublishConfigs = (0, _bluebirdLst().coroutine)(function* (platformPackager, targetSpecificOptions, arch, errorIfCannot) {
...
function resolvePublishConfigurations(_x12, _x13, _x14, _x15, _x16) {
  return _resolvePublishConfigurations.apply(this, arguments);
}

function _resolvePublishConfigurations() {
  _resolvePublishConfigurations = (0, _bluebirdLst().coroutine)(function* (publishers, platformPackager, packager, arch, errorIfCannot) {
    if (publishers == null) {
...
function getResolvedPublishConfig(_x17, _x18, _x19, _x20, _x21) {
  return _getResolvedPublishConfig.apply(this, arguments);
} function _getResolvedPublishConfig() {
  _getResolvedPublishConfig = (0, _bluebirdLst().coroutine)(function* (platformPackager, packager, options, arch, errorIfCannot) {
    ...
    function _getInfo() {
      _getInfo = (0, _bluebirdLst().coroutine)(function* () {
