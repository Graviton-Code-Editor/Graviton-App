...
function getReleaseInfo(_x) {
  return _getReleaseInfo.apply(this, arguments);
}

function _getReleaseInfo() {
  _getReleaseInfo = (0, _bluebirdLst().coroutine)(function* (packager) {
...
function createUpdateInfoTasks(_x2, _x3) {
  return _createUpdateInfoTasks.apply(this, arguments);
}

function _createUpdateInfoTasks() {
  _createUpdateInfoTasks = (0, _bluebirdLst().coroutine)(function* (event, _publishConfigs) {
...
function createUpdateInfo(_x4, _x5, _x6) {
  return _createUpdateInfo.apply(this, arguments);
}

function _createUpdateInfo() {
  _createUpdateInfo = (0, _bluebirdLst().coroutine)(function* (version, event, releaseInfo) {
    const customUpdateInfo = event.updateInfo;
    const url = path.basename(event.file);
    const sha512 = (customUpdateInfo == null ? null : customUpdateInfo.sha512) || (yield (0, _hash().hashFile)(event.file));
    const files = [{
      url,
      sha512
    }];
...
function writeUpdateInfoFiles(_x7, _x8) {
  return _writeUpdateInfoFiles.apply(this, arguments);
} // backward compatibility - write json file


function _writeUpdateInfoFiles() {
  _writeUpdateInfoFiles = (0, _bluebirdLst().coroutine)(function* (updateInfoFileTasks, packager) {
    ...
    /*#__PURE__*/
    function () {
      var _ref = (0, _bluebirdLst().coroutine)(function* (task) {
...
function writeOldMacInfo(_x9, _x10, _x11, _x12, _x13, _x14, _x15) {
  return _writeOldMacInfo.apply(this, arguments);
} function _writeOldMacInfo() {
  _writeOldMacInfo = (0, _bluebirdLst().coroutine)(function* (publishConfig, outDir, dir, channel, createdFiles, version, packager) {
