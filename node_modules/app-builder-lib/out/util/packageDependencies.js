...
function getProductionDependencies(_x) {
  return _getProductionDependencies.apply(this, arguments);
}

function _getProductionDependencies() {
  _getProductionDependencies = (0, _bluebirdLst().coroutine)(function* (folder) {
    const result = [];
...
function readNodeModulesDir(_x2) {
  return _readNodeModulesDir.apply(this, arguments);
} function _readNodeModulesDir() {
  _readNodeModulesDir = (0, _bluebirdLst().coroutine)(function* (dir) {
    let files;
