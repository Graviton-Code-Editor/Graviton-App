...
function modifyMainPackageJson(_x, _x2, _x3) {
  return _modifyMainPackageJson.apply(this, arguments);
} function _modifyMainPackageJson() {
  _modifyMainPackageJson = (0, _bluebirdLst().coroutine)(function* (file, extraMetadata, isRemovePackageScripts) {
