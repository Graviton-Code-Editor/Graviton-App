...
function readAsar(_x) {
  return _readAsar.apply(this, arguments);
}

function _readAsar() {
  _readAsar = (0, _bluebirdLst().coroutine)(function* (archive) {
...
function readAsarJson(_x2, _x3) {
  return _readAsarJson.apply(this, arguments);
}

function _readAsarJson() {
  _readAsarJson = (0, _bluebirdLst().coroutine)(function* (archive, file) {
...
function readFileFromAsar(_x4, _x5, _x6) {
  return _readFileFromAsar.apply(this, arguments);
} function _readFileFromAsar() {
  _readFileFromAsar = (0, _bluebirdLst().coroutine)(function* (filesystem, filename, info) {
