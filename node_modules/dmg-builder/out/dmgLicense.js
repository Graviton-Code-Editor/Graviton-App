...
function addLicenseToDmg(_x, _x2) {
  return _addLicenseToDmg.apply(this, arguments);
}

function _addLicenseToDmg() {
  _addLicenseToDmg = (0, _bluebirdLst().coroutine)(function* (packager, dmgPath) {
