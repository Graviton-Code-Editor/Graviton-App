...
const windows = puffin.element(`
    <div class="controls">
        <button title="Minimize" onclick="g_window.minimize(); " id="minimize" style=" height: auto;">
        ...
        <button title="Maximize" onclick="g_window.maximize(); " id="maximize" style=" height: auto;">
