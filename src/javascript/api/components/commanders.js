...
module.exports = {
  ...
  commanders: {
    terminal: function(object) {
      ...
      if (terminal != null) {
        if (
          document.getElementById(current_screen.terminal.id + "_commander")
            .style.display == "none"
        ) {
    ...
    show: function() {
      if (terminal != null)
        document.getElementById(terminal.id + "_commander").style = "";
    },
    close: function() {
      if (terminal != null)
        document.getElementById(terminal.id + "_commander").remove();
    },
